...
#——————————————————导入数据——————————————————————
f=open('t1.csv')
df=pd.read_csv(f,sep=';')     #读入股票数据
data=df.iloc[:,0:8].values  #取第3-10列
...
# 获取测试集
def get_test_data(time_step=20, test_begin=800):
...
def train_lstm(batch_size=60, time_step=20, train_begin=0, train_end=800):
    ...
    with tf.Session() as sess:
        ...
        print("model_save: ", saver.save(sess, os.getcwd()+'/modle.ckpt'))
